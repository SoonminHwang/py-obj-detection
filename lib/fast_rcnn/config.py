...
# Default setting for VOC2007, ZF
__C.SOLVER.BASE_LR = 0.001
__C.SOLVER.LR_POLICY = "step"
__C.SOLVER.GAMMA = 0.1
__C.SOLVER.STEPSIZE = 50000
__C.SOLVER.DISPLAY = 20
__C.SOLVER.AVERAGE_LOSS = 100
__C.SOLVER.MOMENTUM = 0.9
__C.SOLVER.WEIGHT_DECAY = 0.0005

# Custom snapshot
__C.SOLVER.SNAPSHOT = 0
__C.SOLVER.SNAPSHOT_PREFIX = "zf_faster_rcnn"
__C.SOLVER.ITER_SIZE = 2
...
__C.TRAIN.USE_AUGMENTATION.FLIP = True
__C.TRAIN.USE_AUGMENTATION.CROP = False
__C.TRAIN.USE_AUGMENTATION.GAMMA = False

__C.TRAIN.USE_AUGMENTATION.IM_SCALES = (0.25, 0.5, 0.75, 1.0, 1.25, 1.5)
